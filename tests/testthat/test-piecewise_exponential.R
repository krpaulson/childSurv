...
test_that("piecewise_exponential runs with no error when VR only", {
  ...
  expect_no_error(piecewise_exponential(
    data_vr = data_vr,
    time_model = "rw2",
    count_model = "poisson",
    start_year = 1950,
...
test_that("piecewise_exponential runs with no error when FBH only", {
  #load(testthat::test_path("data/fbh_test_data.RData"))
  # TODO: need to prep piecewise exponential pseudolik input data here
  expect_no_error(piecewise_exponential(
    data_fbh = data_fbh,
    data_pp = data_pp,
    time_model = "rw2",
...
test_that("piecewise_exponential runs with no error with pre-processed only", {
  ...
  pred <- testthat::expect_no_error(piecewise_exponential(
    data_pp = data_pp,
    time_model = "rw2",
