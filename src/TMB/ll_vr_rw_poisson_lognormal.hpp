...
template <class Type>
Type ll_vr_rw_poisson_lognormal(objective_function<Type>* obj) {
  ...
  // hyperpriors
  nll -= dpcprec(log_tau_delta_log_shape, Type(10.0), Type(0.5), true); //1.0, 0.01
   ...
   */
  //nll -= dnorm(log_phi, Type(20.0), Type(10.0), true); // 0.5, 1.0
